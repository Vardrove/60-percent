...
class best_seller{
  ...
  Future<List<QueryDocumentSnapshot>> get products async {
    DocumentSnapshot a=await FirebaseFirestore.instance.collection('best_sellers').doc('5IgFfzn8nDpHasavvDc1').collection('products').doc('rNr3TQXZbIBSsSysr5F4').get();
  ...
  Future<List<QueryDocumentSnapshot>> get sale_products async {
    DocumentSnapshot a=await FirebaseFirestore.instance.collection('best_sellers').doc('5IgFfzn8nDpHasavvDc1').collection('sale_product').doc('ZJLRduXfVPX5OAj9nHh4').get();
    List<String> best = new List<String>.from(a.data().values.first);
