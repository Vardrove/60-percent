      ...
      try{
        ...
        if(result.user!=null){
          ...
          await _firestore.collection('users').doc(result.user.uid).set({
            ...
            'name':name,
            'profilepic':"https://firebasestorage.googleapis.com/v0/b/vardrobe-b0dae.appspot.com/o/notloggedin.png?alt=media&token=dce57a42-7099-4e2b-a6a4-f76bba2fc17d",
