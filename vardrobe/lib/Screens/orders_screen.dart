...
import 'package:vardrobe/Widgets/ordersfilter.dart';
                  ...
                  child: Column(
                    children: <Widget>[
                      Row(
                        ...
                        children: <Widget>[
                          Text("Order N.o: 1",style: TextStyle(fontSize:16.0 ,fontFamily: kfontfamily,),),
                          Text("01-12-2021",style: TextStyle(fontSize:16.0 ,fontFamily: kfontfamily,color: Colors.grey),),
                        ],
                      ),
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          Text("Awzxf1245",style: TextStyle(fontSize:16.0 ,fontFamily: kfontfamily,color: Colors.grey),),
                        ],
                      ),
                      const SizedBox(height: 10.0,),
                      Row(
                        ...
                        children: <Widget>[
                          Row(
                            children: <Widget>[
                              ...
                              Text("3",style: TextStyle(fontSize:16.0 ,fontFamily: kfontfamily,color: Colors.grey),),
                            ],
                          ),
                          Row(
                            children: <Widget>[
                              Text("Total amount: ",style: TextStyle(fontSize:16.0 ,fontFamily: kfontfamily),),
                              Text("112\$",style: TextStyle(fontSize:16.0 ,fontFamily: kfontfamily,color: Colors.grey),),
                            ],
                          ),
                        ],
                      ),
