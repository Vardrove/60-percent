...
import 'package:vardrobe/Services/authenticationanduserprovider.dart';
              ...
              builder: (context,AsyncSnapshot<QuerySnapshot>snapshot){
                if(snapshot.hasError){
                  ...
                  return Column(
                    ...
                    return cart_item(color:list[index]['color'],item_name:list[index]['item_name'], quantity:list[index]['quantity'], size:list[index]['size'], prodid:list[index]['productid'], image_url:list[index]['image_url'], item_price:list[index]['item_price'],saleprod:list[index]['saleprod'] ,);
                    },
                    ),
                      ),
                      Row(
